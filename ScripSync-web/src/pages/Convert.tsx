            ...
            <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
              <div>
                ...
                <p className="mt-2 max-w-3xl text-sm text-slate-200/90">
                  左侧查看 AI 推理过程与微调区，中间编辑 YAML，右侧实时预览剧本结构，让生成、修改与验证集中在同一工作区完成。
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                  ...
                  <div className="space-y-4 px-5 py-5">
                    <div className="grid md:grid-cols-2 gap-4 xl:grid-cols-1">
                      <div>
                        <label className="block text-sm font-medium text-slate-700 mb-2">作品标题</label>
                        <input
                          value={title}
                    ...
                    <div>
                      ...
                      <textarea
                        value={inputText}
                        onChange={(e) => setInputText(e.target.value)}
                        className="h-48 w-full resize-none rounded-xl border border-slate-300 p-4 font-mono text-sm focus:border-transparent focus:ring-2 focus:ring-amber-500"
                      />
                    </div>
                ...
                <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                  ...
                  <div className="space-y-4 px-5 py-5">
                    ...
                    <textarea
                      ...
                      className="h-56 w-full resize-none rounded-xl border border-slate-300 p-4 text-sm focus:border-transparent focus:ring-2 focus:ring-indigo-500"
                    />
                    <div className="flex justify-end">
                      <button
