...
## 演示视频
- 百度网盘：
- 链接: https://pan.baidu.com/s/1B8C44j5uIghO4rQsRb_Fkw?pwd=83kb 提取码: 83kb
- yaml导出效果：
![img_1.png](img_1.png)
...
### 结语
ScriptSync-AI 致力于为创作者提供一个高效、智能的剧本创作与管理工具。通过结合 AI 能力与本地规则，我们希望能够帮助用户更轻松地将创意转化为结构化的剧本数据，并在此基础上进行持续的调整与优化。欢迎大家试用、反馈和贡献！
